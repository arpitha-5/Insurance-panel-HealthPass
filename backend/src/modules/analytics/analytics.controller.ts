...
router.get('/kpi', authenticateJWT, async (req: AuthenticatedRequest, res: Response) => {
  try {
    // Count operations
...
router.get('/trends', authenticateJWT, async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.get('/export-csv', authenticateJWT, async (req: AuthenticatedRequest, res: Response) => {
  try {
